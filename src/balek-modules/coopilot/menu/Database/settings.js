define(['dojo/_base/declare',
        'dojo/_base/lang',
        'dojo/topic',
        'balek-modules/coopilot/Database',

    ],
    function (declare, lang, topic,  coopilotDatabaseController) {
        return declare("moduleCoopilotMenuSettingsDatabaseController", [coopilotDatabaseController], {
            _instanceKey: null,
            _Collection: "MenuSettings",

            _userKey: null,
            constructor: function (args) {
                declare.safeMixin(this, args);
                console.log("moduleCoopilotMenuSettingsDatabaseController starting...");
